...
functions = Map.fromList
  ...
  , ( "catV",    \(Just ([t], [r1, r2]))     _ -> (prim "catV",     [accArg 1 t, accArg 1 t], Acc 1 t) )
  ...
  , ( "dropV",   \(Just ([t], [r]))          _ -> (prim "dropV",    [expArg IntT, accArg 1 t], Acc 1 t) )
  ...
  , ( "snocV",   \(Just ([t], [r]))          _ -> (prim "snocV",    [accArg 1 t, expArg t], Acc 1 t) )
